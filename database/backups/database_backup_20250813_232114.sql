...
--
-- Name: blog_logs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.blog_logs (
    id text NOT NULL,
...
CREATE TABLE public.blogs (
    ...
    instructions text,
    content text,
    status public."BlogStatus" DEFAULT 'QUEUED'::public."BlogStatus" NOT NULL,
...
--
-- Name: llm_calls; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.users (
    ...
    image text,
    role public."UserRole" DEFAULT 'FREE'::public."UserRole" NOT NULL,
    created_at timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp(3) without time zone NOT NULL,
    monthly_generations integer DEFAULT 0 NOT NULL,
    last_generation_reset timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: blog_logs blog_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: llm_calls llm_calls_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: audit_sessions audit_sessions_blog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.audit_sessions
    ADD CONSTRAINT audit_sessions_blog_id_fkey FOREIGN KEY (blog_id) REFERENCES public.blogs(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.audit_sessions
    ADD CONSTRAINT audit_sessions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: blog_logs blog_logs_blog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_logs
    ADD CONSTRAINT blog_logs_blog_id_fkey FOREIGN KEY (blog_id) REFERENCES public.blogs(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.blogs
    ADD CONSTRAINT blogs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: llm_calls llm_calls_audit_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.llm_calls
    ADD CONSTRAINT llm_calls_audit_session_id_fkey FOREIGN KEY (audit_session_id) REFERENCES public.audit_sessions(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: TABLE audit_sessions; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE blog_logs; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE llm_calls; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE verificationtokens; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.verificationtokens TO anon;
GRANT ALL ON TABLE public.verificationtokens TO authenticated;
