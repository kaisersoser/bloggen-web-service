...
async def test_detailed_flow_execution():
    ...
    try:
        async with aiohttp.ClientSession(connector=connector) as session:
            ...
            print(f"📝 Creating blog generation task at {datetime.now().strftime('%H:%M:%S')}")
            ...
            async with session.post(
                    ...
                    async for line in sse_response.content:
                        ...
                        if line_str.startswith('data: '):
                            ...
                            try:
                                ...
                                print(f"📨 [{elapsed:.1f}s] Message {message_count}: {msg_type}")
                                ...
                                print(f"❌ Invalid JSON in message {message_count}: {e}")
                ...
                if message_count <= 3:
                    ...
                    print("   Expected messages: connected, agent_thinking, tool_usage, research_finding, content_stream, completed")
...
async def main():
    ...
    if success:
        ...
        print("❌ Flow is bypassing detailed phases - need to investigate CrewAI execution")
