...
class ContentValidator:
    ...
    def validate_content(cls, content: str) -> Dict[str, Any]:
        ...
        if deprecated_count > 0:
            suggestions.append(
                "Replace deprecated image sources with proper tool-generated images"
            )
            suggestions.append(
                "Use unsplash_image_search or openai_image_generate tools"
            )
        ...
        if total_images == 0:
            ...
            suggestions.append(
                "All images appear to be from invalid sources - use proper tools"
            )
    ...
    def log_validation_results(
        cls, validation: Dict[str, Any], context: str = ""
    ) -> None:
        ...
        logger.info(
            f"{prefix}📊 Images: {validation['total_images']} total, "
