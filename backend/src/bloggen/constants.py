...
DEFAULT_BLOG_SECTIONS = ["Introduction", "Main Content", "Analysis", "Conclusion"]
...
def calculate_openai_cost_legacy(
    model: str, input_tokens: int, output_tokens: int
) -> tuple[float, float, float]:
    """Legacy cost calculation function for backward compatibility."""
    input_cost, _, output_cost, total_cost = calculate_openai_cost(
