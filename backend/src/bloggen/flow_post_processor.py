...
class FlowPostProcessor:
    ...
    @classmethod
    def process_blog_content(cls, content: str, topic: str = "", force_tool_usage: bool = True) -> str:
        """
    ...
    def _add_fallback_image(cls, content: str, topic: str) -> str:
        ...
        try:
            ...
            # Get image from tool
            image_result = unsplash_tool._run(query=query, count=1, orientation="landscape")
