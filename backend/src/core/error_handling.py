    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.error(f"Failed in {phase_name} phase: {str(e)}", extra=error_details)
                raise BlogGenError(f"Flow failed in {phase_name}: {str(e)}", "FLOW_ERROR", error_details)
...
def create_error_response(
    error: Union[Exception, BlogGenError],
