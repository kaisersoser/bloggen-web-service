...
class ContentStreamingManager:
    ...
    async def stream_research_finding(self, task_id: str, finding: str):
        ...
        try:
            ...
            logger.debug(f"Streamed research finding for task {task_id}: {cleaned_finding[:100]}...")
    ...
    async def stream_content_paragraph(self, task_id: str, paragraph: str):
        ...
        try:
            ...
            logger.debug(f"Streamed content paragraph for task {task_id}: {cleaned_paragraph[:100]}...")
    ...
    async def stream_fact_correction(self, task_id: str, correction: str):
        ...
        try:
            ...
            logger.debug(f"Streamed fact correction for task {task_id}: {cleaned_correction[:100]}...")
    ...
    async def _broadcast_streaming_content(self, task_id: str, streaming_content: StreamingContent):
