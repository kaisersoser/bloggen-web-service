...
current_user_role: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    "user_role", default=None
)

# Blog generation context
current_blog_id: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    "blog_id", default=None
)
current_topic: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    "topic", default=None
)
...
current_audit_tracker: contextvars.ContextVar[Optional[object]] = (
    contextvars.ContextVar("audit_tracker", default=None)
)
...
# Timestamps
request_start_time: contextvars.ContextVar[Optional[datetime]] = contextvars.ContextVar(
