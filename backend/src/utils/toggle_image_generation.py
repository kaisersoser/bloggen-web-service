...
def print_status():
    ...
    print(
        f"   AI Image Generation (OpenAI): {'✅ Enabled' if status['ai_image_generation'] else '❌ Disabled'}"
    )
    print(
        f"   Hero Image Generation: {'✅ Enabled' if status['hero_image_generation'] else '❌ Disabled'}"
    )
    print(
        f"   Content Image Injection: {'✅ Enabled' if status['content_image_injection'] else '❌ Disabled'}"
    )
...
def main():
    ...
    parser.add_argument(
        "--disable", action="store_true", help="Disable all AI image generation"
    )
    parser.add_argument(
        "--enable", action="store_true", help="Enable all AI image generation"
    )
    parser.add_argument(
        "--hero-only", action="store_true", help="Enable only hero images"
    )
