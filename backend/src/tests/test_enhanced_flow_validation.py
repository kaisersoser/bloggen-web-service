...
"""
    ...
    print(f"Bad content validation - Valid: {validation['valid']}, Deprecated: {validation['deprecated_images']}")
    
    # Clean the content
    cleaned = ContentValidator.clean_deprecated_images(bad_content)
    cleaned_validation = ContentValidator.validate_content(cleaned)
    print(f"Cleaned content validation - Valid: {cleaned_validation['valid']}, Deprecated: {cleaned_validation['deprecated_images']}")
    ...
    assert cleaned_validation['deprecated_images'] == 0, "Cleaned content should have no deprecated images"
