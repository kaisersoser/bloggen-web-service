...
async def monitor_redis_during_blog_generation():
    ...
    try:
        ...
        try:
            ...
            print("❌ valid_jwt_token.txt not found - please generate a valid JWT token first")
            return False
        ...
        async with aiohttp.ClientSession(connector=connector) as session:
            ...
            async with session.post(
                ...
                json={"topic": "The Future of AI in 2025", "instructions": "Write a comprehensive overview"},
                ...
                async for message in pubsub.listen():
                    if message['type'] == 'message':
                        ...
                        try:
                            ...
                            print(f"📨 Redis message {message_count}: {status} | {phase} | {progress}%")
                ...
                if message_count > 0:
                    ...
                    print("💡 This explains the SSE timeouts - no Redis messages to receive")
...
async def main():
    ...
    if success:
        ...
        print("🔧 If SSE still times out, the issue is in the SSE endpoint Redis listening logic")
    else:
